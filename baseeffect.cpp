...
BaseEffect::BaseEffect(effect a)
{
    ...
    switch (a) {
    case effect::Sharpening:
        matrixeffect[0] = new float[3]{-1, 0, -1};
        matrixeffect[1] = new float[3]{0, 5, 0};
        matrixeffect[2] = new float[3]{-1, 0, -1};
        divisore = 1;
        break;
    case effect::Blur:
        matrixeffect[0] = new float[3]{1, 1, 1};
        matrixeffect[1] = new float[3]{1, 1, 1};
        matrixeffect[2] = new float[3]{1, 1, 1};
        divisore = 9;
        break;
    case effect::EdgeDetection:
        matrixeffect[0] = new float[3]{1, 0, -1};
        matrixeffect[1] = new float[3]{2, 0, -2};
        matrixeffect[2] = new float[3]{1, 0, -1};
        divisore = 1;
        break;
    case effect::Contrast:
        matrixeffect[0] = new float[3]{0, -1, 0};
        matrixeffect[1] = new float[3]{-1, 5, -1};
        matrixeffect[2] = new float[3]{0, -1, 0};
        divisore = 1;
        break;
    }
}
...
void BaseEffect::processingBlur(QImage &img, int width, int height)
{
    ...
    for (int i = 0; i < height; i++) {
        for (int j = 0; j < width; j++) {
            ...
            if (red
                > 255) { //controllo sulla correttezza dei valori .. valori maggiori del range di colori vengano settati a 255
                red = 255;
            }
            if (blue > 255) {
                blue = 255;
