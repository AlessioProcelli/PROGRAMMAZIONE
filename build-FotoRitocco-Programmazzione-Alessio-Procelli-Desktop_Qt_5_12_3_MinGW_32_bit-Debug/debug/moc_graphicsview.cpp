...
#include "../../FotoRitocco-Programmazzione-Alessio-Procelli/graphicsview.h"
...
QT_MOC_LITERAL(1, 13, 12), // "beginDrawing"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1), // "x"
QT_MOC_LITERAL(4, 29, 1), // "y"
QT_MOC_LITERAL(5, 31, 7) // "drawing"

    },
    "GraphicsView\0beginDrawing\0\0x\0y\0drawing"
};
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->beginDrawing((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->drawing((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::beginDrawing)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GraphicsView::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphicsView::drawing)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GraphicsView::beginDrawing(int _t1, int _t2)
{
...
// SIGNAL 1
void GraphicsView::drawing(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
